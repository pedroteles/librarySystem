...
public partial class Admin_PendingMembers : System.Web.UI.Page
{
    ...
    private void setAsMember(string userId)
    {
        ...
        con.Open();
        string sql = "INSERT INTO UsersInRoles (UserId, RoleId) SELECT @UserId, [RoleId] FROM Roles WHERE [RoleName] = 'member' ";
